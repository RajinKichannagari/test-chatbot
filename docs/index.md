...
!!! info
    ...
    **Source Code Repository:** [https://github.com/RajinKichannagari/test-chatbot](https://github.com/RajinKichannagari/test-chatbot)

    **GitOps Repository:** [https://github.com/RajinKichannagari/test-chatbot-gitops](https://github.com/RajinKichannagari/test-chatbot-gitops)

# **Usage**

To access the test-chatbot application that was deployed using the Software Template, complete the following instructions:
